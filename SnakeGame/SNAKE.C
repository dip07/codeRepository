...
void frame()				// drawing the border
{
	...
	for(xx=5,yy=4;xx<=75;xx++)
		{gotoxy(xx,yy);cprintf("อ");}
	for(xx=76,yy=5;yy<=45;yy++)
		{gotoxy(xx,yy);cprintf("บ");}
	for(xx=5,yy=46;xx<=75;xx++)
		{gotoxy(xx,yy);cprintf("อ");}
	for(xx=4,yy=5;yy<=45;yy++)
		{gotoxy(xx,yy);cprintf("บ");}
	textcolor(RED);
	gotoxy(4,4);cprintf("ษ");
	gotoxy(76,4);cprintf("ป");
	gotoxy(4,46);cprintf("ศ");
	gotoxy(76,46);cprintf("ผ");
}
...
void chooselevel()
{
	...
	for(xx=34,yy=24;yy<=26;yy++)
		{
		gotoxy(xx,yy);cprintf("ณ");
		}
	for(xx=46,yy=24;yy<=26;yy++)
		{
		gotoxy(xx,yy);cprintf("ณ");
		}
	gotoxy(34,23);cprintf("ฺ");
	gotoxy(46,23);cprintf("ฟ");
	gotoxy(34,27);cprintf("ภ");
	gotoxy(46,27);cprintf("ู");
	while(scan!=28)
	{
...
void help_level()
{
	...
	gotoxy(22,23);cprintf("ษ");
	gotoxy(58,23);cprintf("ป");
	gotoxy(22,28);cprintf("ศ");
	gotoxy(58,28);cprintf("ผ");
...
void help_maze()
{
	...
	gotoxy(19,22);cprintf("ษ");
	gotoxy(71,22);cprintf("ป");
	gotoxy(19,29);cprintf("ศ");
	gotoxy(71,29);cprintf("ผ");
...
void help_game()
{
	...
	gotoxy(22,22);cprintf("ษ");
	gotoxy(57,22);cprintf("ป");
	gotoxy(22,29);cprintf("ศ");
	gotoxy(57,29);cprintf("ผ");
...
void quit()
{
	...
	gotoxy(30,24);cprintf("ษออออออออออออออออป");
	gotoxy(30,25);cprintf("บ                บ");
	gotoxy(30,26);cprintf("ศออออออออออออออออผ");
